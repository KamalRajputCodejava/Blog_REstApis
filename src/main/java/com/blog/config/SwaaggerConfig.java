...
public class SwaaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging App", "this is for learning purpose", "1.0", "Terms of Service",
				new Contact("Kamal Rajput","Blogg_app", "suryavanshikamal@gmail.com"),"license is Open",
